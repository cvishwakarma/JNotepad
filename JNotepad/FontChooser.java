...
public class FontChooser extends JPanel {
    ...
    private final JList jFace, jStyle, jSize;
    ...
    public FontChooser(Font withFont) {
        ...
        jFace.addListSelectionListener((ListSelectionEvent ev) -> {
        ...
        jStyle.addListSelectionListener((ListSelectionEvent ev) -> {
            tf.setFont(createFont());
        });
        ...
        jSize.addListSelectionListener((ListSelectionEvent ev) -> {
            tf.setFont(createFont());
        });
